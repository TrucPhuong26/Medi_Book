...
//                     } catch (e) {
//                       ScaffoldMessenger.of(context).showSnackBar(
//                         SnackBar(content: Text('Lỗi không thể lưu mật khẩu: $e')),
//                       );
//                     }
//                   },
//                   child: const Text(
...
//     Color titleColor = isDark ? Colors.white : Colors.black;      // Nền sáng: Đen hẳn | Nền tối: Trắng hẳn
//     Color subtitleColor = isDark ? Colors.white70 : Colors.black87; // Nền sáng: Đen đậm | Nền tối: Trắng xám dễ nhìn
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> changePassword() async {
    ...
    await showDialog(
      context: context,
      barrierDismissible: false, // Ngăn người dùng bấm ra ngoài tắt ngang khi đang xử lý
      builder: (_) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              actions: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    // --- BẬT VÒNG XOAY LOADING ĐỂ ĐỢI ĐỒNG BỘ MẠNG ---
                    showDialog(
                      context: context,
                    ...
                    try {
                      ...
                      // Vì LoginScreen tìm doc theo ID là email, nên ta trỏ trực tiếp bằng .doc(userEmail)
                      ...
                      Navigator.pop(context); // Tắt Dialog nhập mật khẩu mới
                      ...
                      Navigator.pop(context); // Tắt Dialog Loading nếu dính lỗi mạng
